...
use PHPStanNetteLinks\Exceptions\InvalidLinkDestinationException;
use PHPStanNetteLinks\Exceptions\InvalidLinkException;
use PHPStanNetteLinks\Exceptions\InvalidLinkParamsException;
use PHPStanNetteLinks\Exceptions\LinkCheckFailedException;
use PHPStanNetteLinks\Exceptions\PresenterResolvingException;
use PHPStanNetteLinks\Exceptions\PresenterResolvingNotAvailableException;
use Throwable;
