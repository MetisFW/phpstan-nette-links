...
class PresenterLinksRuleTest extends RuleTestCase
{
	...
	public function testRuleForPresenter(): void
	{
		...
		$this->analyse([__DIR__ . '/data/links-presenter.php'], [
			...
			[
				'Invalid link params in link() call: Argument $param passed to PHPStanNetteLinks\TestApp\Presenters\CurrentModule\CurrentPresenter::actionWithParam() must be int, null given.',
				30,
			],
			[
				'Invalid link params in link() call: Argument $param passed to PHPStanNetteLinks\TestApp\Presenters\CurrentModule\CurrentPresenter::actionWithParam() must be int, null given.',
			...
			[
				'Invalid link destination \'unknown!\' in link() call: Unknown signal \'unknown\', missing handler PHPStanNetteLinks\TestApp\Presenters\CurrentModule\CurrentPresenter::handleUnknown()',
				37,
			],
			[
